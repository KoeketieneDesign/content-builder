...
namespace koeketienedesign\contentbuilder\records;
 ...
 * @since     1.0.0
 */
class ContentBuilderRecord extends ActiveRecord
{
    ...
    {
        return '{{%contentbuilder_contentbuilderrecord}}';
    }
}
