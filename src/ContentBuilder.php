...
namespace koeketienedesign\contentbuilder;

use koeketienedesign\contentbuilder\models\Settings;
use koeketienedesign\contentbuilder\fields\ContentBuilderField as ContentBuilderFieldField;
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = ContentBuilderFieldField::class;
            }
        );
