...
namespace koeketienedesign\contentbuilder\fields;

use koeketienedesign\contentbuilder\ContentBuilder;
use koeketienedesign\contentbuilder\assetbundles\contentbuilderfieldfield\ContentBuilderFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class ContentBuilderField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('content-builder', 'ContentBuilderField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'content-builder/_components/fields/ContentBuilderField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ContentBuilderFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ContentBuilderContentBuilderField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'content-builder/_components/fields/ContentBuilderField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
